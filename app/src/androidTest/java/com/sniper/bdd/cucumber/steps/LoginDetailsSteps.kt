...
import com.applitools.eyes.android.common.*
import com.applitools.eyes.android.espresso.*
import com.sniper.bdd.*
...
class LoginDetailsSteps {
    ...
    private val eyes: Eyes = Eyes()

    @Before
    fun setup() {
        //not needed now, but you may needed to setup mock responses before your screen starts
        eyes.setApiKey("6ADPP9ISJ9mzbweOifXxBpH8106nhKPBwDHbpVp0q8qPk110")
    ...
    fun i_expect_to_see_successful_login_message() {
        try {
            ...
            eyes.checkWindow("Login button Clicked")
            eyes.close()
        }finally {
